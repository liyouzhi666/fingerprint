...
private slots:
    ...
    //PF Test
    void on_btnPF1_clicked();
    void on_btnPF2_clicked();
    void on_btnPF3_clicked();
    void on_btnPF4_clicked();
    void on_btnPF5_clicked();
    void on_btnPF6_clicked();
    void on_btnPF7_clicked();
    void wait();
